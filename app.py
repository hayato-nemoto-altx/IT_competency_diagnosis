...
TRAIT_CATEGORY_MAP = {
    ...
    "可用性追求": "技術・実務", "セキュリティ意識": "技術・実務", "キャパシティ予測": "技術・実務", "カオス耐性": "技術・実務",
    "自動化思考": "技術・実務", "根本原因探求": "技術・実務", "技術的負債への感度": "技術・実務", "コスト意識": "技術・実務",
    "バックアップへの執着": "技術・実務", "変更管理": "技術・実務", "ユーザー視点": "技術・実務", "実装スピード": "技術・実務",
    "可読性追求": "技術・実務", "新技術への挑戦": "技術・実務", "再利用性": "技術・実務", "創造的解決": "技術・実務",
    "ビジョン構想": "技術・実務", "採用・組織作り": "技術・実務", "予算・リソース管理": "技術・実務", "成果への執着": "技術・実務",
    "安全第一": "技術・実務", "指差呼称": "技術・実務", "整頓・配線美": "技術・実務", "工具の扱い": "技術・実務",
    "空間認識力": "技術・実務", "物理セキュリティ": "技術・実務", "ハードウェア知見": "技術・実務", "作業迅速性": "技術・実務",
    "現地の眼": "技術・実務", "静寂・環境維持": "技術・実務",

    # --- 仕事の進め方 (Process / Work Style) ---
    "ドキュメント重視": "仕事の進め方", "標準化志向": "仕事の進め方", "リスク検知": "仕事の進め方", "論理的思考": "仕事の進め方",
    "完了主義": "仕事の進め方", "継続学習": "仕事の進め方", "自律性": "仕事の進め方", "優先順位付け": "仕事の進め方",
    "品質へのこだわり": "仕事の進め方", "アジャイル適応": "仕事の進め方", "ビジネス理解": "仕事の進め方", "即断即決": "仕事の進め方",
    "権限委譲": "仕事の進め方", "準備・段取り": "仕事の進め方", "失敗からの学習": "仕事の進め方", "グリット（やり抜く力）": "仕事の進め方",
    "時間管理": "仕事の進め方", "縁の下の力持ち": "仕事の進め方", "サービスマインド": "仕事の進め方", "デモ力": "仕事の進め方",

    # --- 対人・組織 (Communication / Human Skills) ---
    "チーム協調": "対人・組織", "情報の透明性": "対人・組織", "他者へのリスペクト": "対人・組織", "専門用語の翻訳": "対人・組織",
    "支援要請": "対人・組織", "心理的安全性構築": "対人・組織", "合意形成": "対人・組織", "率直なフィードバック": "対人・組織",
    "粘り強さ": "対人・組織", "仕様の翻訳": "対人・組織", "外部折衝力": "対人・組織", "サーバントリーダー": "対人・組織",
    "モチベーション管理": "対人・組織", "フィードバックスキル": "対人・組織", "素直な吸収力": "対人・組織", "質問力": "対人・組織",
    "報連相の徹底": "対人・組織", "元気・挨拶": "対人・組織", "議事録・記録": "対人・組織", "感謝を伝える": "対人・組織",
    "ホスピタリティ": "対人・組織"
}
...
MASTER_QUESTIONS_DB = {
    ...
    "セキュリティ意識": ["利便性が多少犠牲になっても、安全性を優先すべきだ。", "脆弱性情報は毎日チェックしている。", "パスワード管理や権限設定には人一倍厳しい。", "「これくらい大丈夫だろう」という甘い判断は絶対に許さない。", "セキュリティ事故は企業の死に直結すると常に意識している。"],
    ...
    "カオス耐性": ["障害でアラートが鳴り響く中でも冷静にログを見れる。", "想定外のトラブルが起きてもパニックにならず、逆に集中力が増す。", "混乱した状況下で優先順位を即座に判断できる。", "二転三転する状況を楽しめるタフさがある。", "プレッシャーがかかる場面ほど燃えるタイプだ。"],
    "バックアップへの執着": ["バックアップが成功しているか毎日確認しないと落ち着かない。", "「データが消えたら終わり」という危機感を常に持っている。", "リストア（復元）手順を定期的に訓練している。", "冗長化されていないデータを見ると寒気がする。", "最悪のシナリオを想定して準備するのが好きだ。"],
    ...
    "サービスマインド": ["社内の開発者が快適に作業できる環境を提供したい。", "「開発環境が遅い」と言われたらすぐに改善したくなる。", "インフラは開発者へのサービス業だと捉えている。", "依頼に対して「できません」と即答せず、代替案を考える。", "相手の困りごとを技術で解決してあげたい。"],
    "指差呼称": ["作業対象を指差し、声に出して確認する癖がついている。", "思い込みによる操作ミスを防ぐための確認動作を怠らない。", "「ヨシ！」という掛け声がないと作業に入れない。", "確認不足によるミスは恥ずべきことだと思う。", "安全確認の手順を省略することは絶対にない。"],
    "整頓・配線美": ["ケーブルが乱雑に配線されていると直したくてうずうずする。", "美しい配線はエアフローとメンテナンス性に必須だと思う。", "ラベルの貼り方や結束バンドの処理にも美学を持っている。", "整理整頓されたラックを見ると心が落ち着く。", "汚い現場からは良い仕事は生まれないと信じている。"],
    ...
    "物理セキュリティ": ["入館証や鍵の管理には神経質なほど気を使う。", "共連れ入館を見かけたら注意せずにはいられない。", "物理的な不正侵入のリスクを常に警戒している。", "施錠確認を徹底しないと帰れない。", "セキュリティゲートを通過するとき背筋が伸びる。"],
    ...
    "現地の眼": ["現場のLEDの状態や異音を、電話先の相手に正確に伝えられる。", "現地の状況を言葉で描写する能力に長けている。", "リモート指示者の目となり耳となる意識を持っている。", "些細な違和感も見逃さずに報告する。", "現場で起きている「事実」を伝えることに徹している。"],
    ...
    "静寂・環境維持": ["サーバールームの温度や湿度が規定値から外れると気になる。", "埃やゴミが落ちているとすぐに掃除したくなる。", "マシンのファン音が変わったことに気づくことがある。", "機器にとって最適な環境を守る番人だという意識がある。", "整然とした静寂（ファンの音だけがする状態）を守りたい。"],
    ...
    "安全第一": ["作業スピードよりも、自分と仲間の安全を最優先にしている。","高所作業や重量物運搬の際、保護具や手順を絶対に省略しない。","少しでも危険を感じたら、作業を中断する勇気を持っている。","「怪我をしないこと」がプロフェッショナルの第一条件だと思っている。","ヒヤリハット（事故の一歩手前）を見逃さず、対策を講じている。"],

    # --- アプリ・開発系 ---
    "ユーザー視点": ["技術的にすごくても、使いにくい機能はゴミだと思う。", "常に「ユーザーならどう感じるか？」を考えて実装している。", "UX（ユーザー体験）を損なう仕様にはNOと言える。", "自分の作ったものをユーザーとして使い倒すことが多い。", "画面の向こうにいる人の顔を想像して仕事をしている。"],
    "実装スピード": ["完成度100%を目指すより、まずは動くものを作ってリリースしたい。", "「とりあえずやってみる」精神でコードを書き始める。", "市場に出すスピード（Time to Market）を最優先する。", "悩み続けるより手を動かして検証するタイプだ。", "プロトタイプを爆速で作るのが得意だ。"],
    "可読性追求": ["自分以外の誰が見てもわかる「きれいなコード」書きたい。", "変数名の命名にはかなりこだわる。", "スパゲッティコードを見るとリファクタリングしたくなる。", "コードは書く時間より読まれる時間の方が長いと知っている。", "美しいコードは芸術だと思う。"],
    "新技術への挑戦": ["新しいフレームワークや言語が出るとすぐに触ってみる。", "枯れた技術より、最新のモダンな技術を使いたい。", "前例のない技術スタックでも恐れずに導入を提案する。", "技術トレンドを追うのが趣味だ。", "常に新しいことに挑戦していないと飽きてしまう。"],
    ...
    "アジャイル適応": ["仕様変更があっても「より良くなるならOK」と受け入れられる。", "計画通りに進むことより、変化に対応することを重視する。", "朝令暮改の環境でもストレスを感じにくい。", "フィードバックを受けて即座に方向修正できる。", "完璧な計画よりも、柔軟な対応力を大切にしている。"],
    "創造的解決": ["既存のやり方に囚われず、アイデアで壁を突破するのが好きだ。", "「無理」と言われると逆に燃えて解決策を探す。", "誰も思いつかなかったような実装方法を思いつくことがある。", "ハック的なアプローチで難題をクリアすることに快感を覚える。", "創意工夫でリソース不足を補うのが得意だ。"],
    "ビジネス理解": ["コードを書くことは手段であり、目的は事業価値を生むことだと理解している。", "エンジニアも売上やKPIを意識すべきだと思う。", "ビジネスにつながらない技術的こだわりは捨てる勇気がある。", "「なぜこの機能が必要なのか」をビジネス視点で説明できる。", "事業の成長にコミットしている。"],
    "仕様の翻訳": ["クライアントのふわっとした要望を、実装可能な仕様に落とし込める。", "エンジニア用語を使わずに仕様を説明できる。", "ビジネス要件と技術的制約のバランスを取るのが得意だ。", "「つまりこういうことですね」と要約して確認する癖がある。", "要件定義の漏れを見つけるのが得意だ。"],
    "デモ力": ["開発中の機能を魅力的に見せるプレゼンが得意だ。", "デモを見せてフィードバックを引き出すのが好きだ。", "動くものを見せるのが一番の説得材料だと思う。", "プレゼン資料よりデモ機を触ってもらうことを優先する。", "自分の作った機能を自慢したい気持ちがある。"],

    # --- マネジメント系 ---
    "ビジョン構想": ["チームや組織の「あるべき姿」をよく語る。", "3年後、5年後の技術ロードマップを描くのが好きだ。", "未来のビジョンでメンバーをワクワクさせたい。", "目の前の課題だけでなく、長期的な方向性を示している。", "夢や理想を語ることはリーダーの責務だと思う。"],
    "採用・組織作り": ["カルチャーにマッチする人材を見抜く目がある。", "チームの弱点を補うための配置を考えるのが好きだ。", "「誰と働くか」が成果に直結すると信じている。", "採用活動には時間と労力を惜しまない。", "強いチームを作るための組織設計に興味がある。"],
    ...
    "外部折衝力": ["他部署やクライアントとの調整役を買って出ることが多い。", "無理難題からチームを守るための交渉ができる。", "政治的な動きや根回しも必要なら厭わない。", "利害関係の調整をしてプロジェクトを円滑に進めるのが得意だ。", "「貸し借り」のバランスを取るのが上手い。"],
    "即断即決": ["情報が不十分でも、止まるよりは決断して進める。", "決断のスピードが組織のスピードを決めると信じている。", "リスクを取って意思決定することに躊躇しない。", "「私が責任を持つからやってくれ」と言える。", "優柔不断な態度を見せることは避けている。"],
    "権限委譲": ["部下を信頼して仕事を任せることができている。", "マイクロマネジメント（細かい干渉）はしないようにしている。", "自分がいなくても回るチームを作りたい。", "失敗させる権利も部下に与えている。", "「任せる」ことの難しさと重要性を理解している。"],
    "サーバントリーダー": ["リーダーの役割はメンバーの障害物を取り除くことだと思う。", "部下が働きやすい環境を作るために汗をかいている。", "「俺についてこい」より「支えるから行ってこい」タイプだ。", "チームの成功が自分の成功だと本気で思える。", "メンバーのために雑用をすることも苦ではない。"],
    ...
    "失敗からの学習": ["ミスをした時、落ち込むだけでなく「なぜ起きたか」を振り返る。", "同じ失敗を二度と繰り返さないための対策を立てる。", "失敗を隠さず、ノートやWikiにまとめて次に活かす。", "失敗経験が自分を強くすると信じている。", "転んでもただでは起きない精神がある。"],
    "元気・挨拶": ["自分から明るく挨拶をして、話しやすい雰囲気を作っている。", "チームが沈んでいる時こそ、元気に振る舞う。", "返事はハッキリと相手に聞こえるようにする。", "コミュニケーションの入り口としての挨拶を大切にしている。", "若手の特権として、場の空気を明るくしたい。"],
    "グリット（やり抜く力）": ["難しい課題にぶつかっても、簡単には投げ出さない。", "地味な作業でも粘り強くやり遂げる。", "一度決めたことは最後までやり抜く根性がある。", "壁にぶつかった時こそ成長のチャンスだと思う。", "諦めの悪さは長所だと思う。"],
    "議事録・記録": ["会議の議事録や作業ログを積極的に残す。", "決定事項やTo Doを聞き漏らさない。", "記録に残すことでチームをサポートしたい。", "メモを取るスピードと正確さには自信がある。", "言った言わないのトラブルを防ぐ防波堤になりたい。"],
    "感謝を伝える": ["教えてもらった時や助けてもらった時、すぐに「ありがとうございます」と言う。", "些細なことでも感謝の言葉を忘れない。", "感謝を伝えることで信頼関係が深まると思う。", "メールやチャットでも感謝の意を一言添える。", "礼儀正しさはスキルの一つだと考えている。"],
    ...
    "技術的負債への感度": ["「とりあえず」のコードが将来の負債になることを予見できる。", "汚いコードや構成を放置することに罪悪感を感じる。", "リファクタリングの時間を確保するよう主張する。", "長期的な保守性を考えて設計する。", "負債の利子（運用コスト）が膨らむのを恐れている。"],
    "標準化志向": ["独自のやり方をせず、チームのルールや規約を守る。", "例外処理を作らず、パターンを統一したい。", "誰がやっても同じ結果になる仕組みを作りたい。", "オレオレ実装を嫌う。", "標準化こそがスケーラビリティの鍵だと思う。"],
    "コスト意識": ["クラウドの利用料やライセンス費用を常に意識している。", "無駄なリソースが起動していると停止したくなる。", "自分の作業工数もコスト換算して考えている。", "投資対効果（ROI）に合わない技術選定はしない。", "会社の金も自分の金のように大切に使う。"],
    "リスク検知": ["変更作業を行う際、影響範囲を瞬時にイメージできる。", "「なんか嫌な予感がする」という勘がよく当たる。", "楽観的な計画に対して、あえてリスクを指摘する。", "最悪のケースを想定して準備する癖がある。", "石橋を叩いて渡る慎重さがある。"],
    "論理的思考": ["感情論ではなく、事実とデータに基づいて判断する。", "「なんとなく」ではなくロジカルに説明できる。", "物事を構造化して考えるのが得意だ。", "矛盾点を見つけるのが早い。", "冷静沈着に物事を分析する。"],
    "完了主義": ["中途半端な状態でタスクを放置するのが気持ち悪い。", "99%と100%（完了）の間には大きな壁があると思う。", "最後のテストや監視設定までやり切ってこそ「完了」だ。", "To Doリストを全て消し込むことに快感を覚える。", "やり遂げる力には自信がある。"],
    "継続学習": ["業務時間外でも技術書を読んだり勉強会に参加したりする。", "新しいことを学ぶのが苦ではなく楽しみだ。", "現状のスキルで満足したら終わりだと思う。", "常に最新情報をキャッチアップしていないと不安になる。", "学習はエンジニアの呼吸と同じだ。"],
    ...
    "チーム協調": ["個人の手柄より、チーム全体の成果を優先する。", "困っているメンバーがいたら自分の作業を止めてでも助ける。", "チームワークが良い時こそ最高のパフォーマンスが出る。", "情報の抱え込みをせず、チームに共有する。", "スタンドプレーより連携を重視する。"],
...
ROLE_CONFIG = {
    "インフラエンジニア": [
        "可用性追求", "セキュリティ意識", "キャパシティ予測", "カオス耐性", "自動化思考",
        "根本原因探求", "ドキュメント重視", "技術的負債への感度", "標準化志向", "コスト意識",
        "リスク検知", "論理的思考", "完了主義", "バックアップへの執着", "継続学習",
        "変更管理", "自律性", "優先順位付け", "縁の下の力持ち", "品質へのこだわり",
        "チーム協調", "情報の透明性", "他者へのリスペクト", "専門用語の翻訳", "支援要請",
        "心理的安全性構築", "合意形成", "サービスマインド", "率直なフィードバック", "粘り強さ"
    ],
    "アプリエンジニア": [
        "ユーザー視点", "実装スピード", "可読性追求", "新技術への挑戦", "自動化思考",
        "根本原因探求", "ドキュメント重視", "技術的負債への感度", "標準化志向", "再利用性",
        "リスク検知", "論理的思考", "完了主義", "アジャイル適応", "継続学習",
        "創造的解決", "自律性", "優先順位付け", "ビジネス理解", "品質へのこだわり",
        "チーム協調", "情報の透明性", "他者へのリスペクト", "仕様の翻訳", "支援要請",
        "心理的安全性構築", "合意形成", "デモ力", "率直なフィードバック", "粘り強さ"
    ],
    "マネジメント層": [
        "ビジョン構想", "採用・組織作り", "予算・リソース管理", "成果への執着", "自動化思考",
        "根本原因探求", "ドキュメント重視", "技術的負債への感度", "標準化志向", "外部折衝力",
        "リスク検知", "論理的思考", "完了主義", "即断即決", "継続学習",
        "権限委譲", "自律性", "優先順位付け", "サーバントリーダー", "品質へのこだわり",
        "チーム協調", "情報の透明性", "他者へのリスペクト", "モチベーション管理", "支援要請",
        "心理的安全性構築", "合意形成", "フィードバックスキル", "率直なフィードバック", "粘り強さ"
    ],
    "新入社員・若手": [
        "素直な吸収力", "質問力", "報連相の徹底", "時間管理", "自動化思考",
        "根本原因探求", "ドキュメント重視", "技術的負債への感度", "標準化志向", "準備・段取り",
        "リスク検知", "論理的思考", "完了主義", "失敗からの学習", "継続学習",
        "元気・挨拶", "自律性", "優先順位付け", "グリット（やり抜く力）", "品質へのこだわり",
        "チーム協調", "情報の透明性", "他者へのリスペクト", "議事録・記録", "支援要請",
        "心理的安全性構築", "合意形成", "感謝を伝える", "率直なフィードバック", "粘り強さ"
    ],
    "DC保守・運用": [
        "安全第一", "指差呼称", "整頓・配線美", "工具の扱い", "標準化志向",
        "リスク検知", "完了主義", "品質へのこだわり", "空間認識力", "物理セキュリティ",
        "根本原因探求", "ハードウェア知見", "作業迅速性", "現地の眼", "論理的思考",
        "ドキュメント重視", "継続学習", "技術的負債への感度", "カオス耐性", "自動化思考",
        "チーム協調", "情報の透明性", "他者へのリスペクト", "ホスピタリティ", "支援要請",
